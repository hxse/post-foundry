...
describe("production run-once source collection integration", () => {
  ...
  it("runs source collection through the production once runner without draft or posting", async () => {
    ...
    try {
      ...
      expect(result).toMatchObject({
        ...
        outcome: "completed",
        finalAction: "source_collection_collected",
        summary: {
      ...
      expect(repo.listEvidenceRefsForAccount(zhAccountUuid)).toHaveLength(3);
