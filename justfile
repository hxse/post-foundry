...
# PROD ONLINE: run one v0 operation loop with real external APIs. Auto-post requires POST_FOUNDRY_ALLOW_REAL_X_POST=1.
...
# PROD ONLINE: loop v0 operation cycles with real external APIs. Auto-post requires POST_FOUNDRY_ALLOW_REAL_X_POST=1.
[arg("account", long="account")]
[arg("config_file", long="config-file")]
[arg("secrets_file", long="secrets-file")]
[arg("db_file", long="db-file")]
